-- =====================================================
-- LIKELEMBA DATABASE SCHEMA - COMPLETE SCRIPT
-- =====================================================
--
-- This file contains all database migrations in order.
-- Run these scripts in your Supabase SQL Editor to recreate the database.
--
-- IMPORTANT: These migrations are idempotent and can be run multiple times.
-- =====================================================

-- =====================================================
-- MIGRATION 1: Create Core Schema
-- File: 20251130025610_create_likelemba_schema.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 2: Add Payment Tracking
-- File: 20251130035746_add_payment_tracking.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 3: Add Shareable Links
-- File: 20251130042325_add_shareable_links.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 4: Add Profile Photo
-- File: 20251130043257_add_profile_photo.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 5: Add Financial Summary Fields
-- File: 20251130053729_add_financial_summary_fields.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 6: Backfill Financial Summary Data
-- File: 20251130054412_backfill_financial_summary_data.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 7: Create Payment Due Notifications
-- File: 20251130061940_create_payment_due_notifications.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 8: Create Member Payment History
-- File: 20251130064342_create_member_payment_history.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 9: Add Group Member Limit Validation
-- File: 20251130073556_add_group_member_limit_validation.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 10: Add Scheduled Payment Dates
-- File: 20251201032727_add_scheduled_payment_dates.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 11: Add Group Status and Pause/Resume
-- File: 20251201040010_add_group_status_and_pause_resume.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 12: Add Service Fee Payment Tracking
-- File: 20251206030503_add_service_fee_payment_tracking.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 13: Create FAQ System
-- File: 20251206052705_create_faq_system.sql
-- =====================================================
...
-- =====================================================
-- MIGRATION 14: Create Admin System
-- File: 20251206062344_create_admin_system.sql
-- =====================================================
