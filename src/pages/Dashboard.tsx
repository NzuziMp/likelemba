      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4">
            <h2 className="text-2xl font-bold text-slate-900">Your Likelemba Groups</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-slate-600 mb-6">Create your first Likelemba group to get started</p>
              <Link
                to="/likelemba"
            ...
            <>
              {groups
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 mb-2">{t('search.noResults')}</h3>
                  <p className="text-slate-600">{t('search.tryAdjusting')}</p>
                </div>
              ) : (
                  ...
                  <div className="space-y-2">
                    <div className="grid grid-cols-3 gap-2">
                      <Link
                        ...
                        className="block text-center px-3 py-2 bg-slate-100 text-slate-700 font-medium rounded-lg hover:bg-slate-200 transition-colors text-sm"
                      >
                        Members
                      </Link>
                      <Link
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-2xl font-bold text-slate-900">{t('dashboard.editGroup')}</h3>
              <button
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-slate-900">{t('dashboard.deleteGroup')}</h3>
            </div>
